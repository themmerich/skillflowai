...
--insert into skillflowai.user(id, email, password, first_name, last_name, tenant_id) values ('8f95c378-329e-4853-bef0-515632d1acf9', 'test@test.de', '$2a$10$Wr9pPa37tJbb3m1V89Oud.4.Sd7KCfPt3a692W1jVOHCh.WCgDwxO', 'Max', 'Mustermann');

--insert into skillflowai.role